          ...
          <div className={"md:grid md:grid-cols-3 gap-8"}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem
                  className={
                    "flex flex-row my-2 md:my-0 items-start space-x-3 space-y-0 rounded-md border p-4"
                  }
                >
                  <FormControl>
                    <Checkbox
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem
                  className={
                    "flex flex-row items-start my-2 md:my-0 space-x-3 space-y-0 rounded-md border p-4"
                  }
                >
                  <FormControl>
                    <Checkbox
